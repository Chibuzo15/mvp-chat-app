    ...
    <>
      ...
      <div className={`fixed top-0 right-0 bottom-0 w-full bg-white rounded-none sm:top-4 sm:right-4 sm:bottom-4 sm:w-[400px] sm:rounded-2xl shadow-2xl flex flex-col z-50 overflow-hidden transition-transform duration-300 ease-out ${
        ...
        <div className="shrink-0 px-6 mb-2">
          <div className="bg-[#F3F3EE] rounded-lg px-[0.5px] py-[0.5px] w-fit">
            <div className="flex gap-1">
            <button
              onClick={() => setActiveTab('media')}
                className={`px-4 py-2 text-xs sm:text-sm lg:text-[14px] font-medium rounded-lg transition-all ${
                activeTab === 'media'
                    ? 'bg-white text-[#111625] border border-gray-200 m-[1px] shadow-sm'
                    : 'text-[#8B8B8B]'
              }`}
            >
              Media
        ...
        <div className="flex-1 overflow-y-auto">
          {activeTab === 'media' && (
            <div className="p-6 space-y-6">
              {/* May */}
              <div>
                <div className="bg-[#F8F8F5] rounded-lg mb-3">
                  <p className="text-xs font-medium text-gray-500 px-3 py-1.5">May</p>
                </div>
              ...
              <div>
                <div className="bg-[#F8F8F5] rounded-lg mb-3">
                  <p className="text-xs font-medium text-gray-500 px-3 py-1.5">April</p>
                </div>
                <div className="grid grid-cols-4 gap-2">
              ...
              <div>
                <div className="bg-[#F8F8F5] rounded-lg mb-3">
                  <p className="text-xs font-medium text-gray-500 px-3 py-1.5">March</p>
                </div>
                <div className="grid grid-cols-4 gap-2">
